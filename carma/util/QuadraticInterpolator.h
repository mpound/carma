#ifndef CARMA_UTIL_QUADRATICINTERPOLATOR_H
#define CARMA_UTIL_QUADRATICINTERPOLATOR_H
...
namespace carma {
  namespace util {
    ...
    public:
       ...
       * Allows cout << QI
       */
      friend std::ostream& operator<<(std::ostream& os, QuadraticInterpolator& quad);
#endif
      void print();
