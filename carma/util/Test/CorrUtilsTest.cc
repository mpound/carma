 ...
 * @file 
 *
 * $Id: CorrUtilsTest.cc,v 1.2 2014/06/03 19:45:36 mpound Exp $
 *
...
void CorrUtilsTest::testNumExpectedAstroChans()
{
    ...
    CPPUNIT_ASSERT(
      numExpectedAstroChans(CORR_ALL , CORR_BW_125MHZ, CORR_4BIT, CORR_SINGLEPOL ) 
                   == 0 ); 
    CPPUNIT_ASSERT(
      numExpectedAstroChans(CORR_ALL , CORR_BW_125MHZ, CORR_4BIT, CORR_CARMA23 ) 
                   == 0 ); 
