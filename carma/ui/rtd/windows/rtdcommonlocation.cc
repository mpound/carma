 ...
 * $Id: rtdcommonlocation.cc,v 1.7 2013/11/19 03:41:14 iws Exp $
 *
 * $CarmaCopyright$
 */
...
{
	return "Common Antenna Location Help\n"
		   "\n"
		   "Status of the Common Antenna Location\n";
}

int carma::util::Program::main()
{
	const std::string title = "Common Antennas Location";
	const std::string helpTitle = "COMMON ANTENNA LOCATION";
