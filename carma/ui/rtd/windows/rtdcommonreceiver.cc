 ...
 * $Id: rtdcommonreceiver.cc,v 1.7 2013/11/19 03:41:14 iws Exp $
 *
 * $CarmaCopyright$
 */
...
{
	return "Common Antenna Receivers Help\n"
		   "\n"
		   "Status of the Common Antenna Receivers\n";
}

int carma::util::Program::main()
{
	const std::string title = "Common Antenna Receivers";
	const std::string helpTitle = "COMMON ANTENNA RECEIVERS";
	...
	for (int carmaAntNo = 1; carmaAntNo <= 23; ++carmaAntNo) {
		...
		container1.push_back(&common.receivers());
	}
