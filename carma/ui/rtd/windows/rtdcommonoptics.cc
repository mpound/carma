 ...
 * $Id: rtdcommonoptics.cc,v 1.8 2013/11/19 03:41:14 iws Exp $
 *
 * $CarmaCopyright$
 */
...
{
	return "Common Antenna Optics Help\n"
		   "\n"
		   "Status of the Common Antenna Optics\n";
}

int carma::util::Program::main()
{
	const std::string title = "Common Antennas Optics";
	const std::string helpTitle = "COMMON ANTENNA OPTICS";
