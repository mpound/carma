 ...
 *
 * ---------------------------
 * StandardXYItemRendererProtected.java
 * ---------------------------
 ...
 */
public class StandardXYItemRendererProtected extends AbstractXYItemRenderer
     ...
     */
    public StandardXYItemRendererProtected() {
        this(LINES, null);
    }
     ...
     * @param type  the type.
     */
    public StandardXYItemRendererProtected(int type) {
        this(type, null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StandardXYItemRendererProtected)) {
            return false;
        }
        StandardXYItemRendererProtected that = (StandardXYItemRendererProtected) obj;
    ...
    public Object clone() throws CloneNotSupportedException {
        StandardXYItemRendererProtected clone = (StandardXYItemRendererProtected) super.clone();
