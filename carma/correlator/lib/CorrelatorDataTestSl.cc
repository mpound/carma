// $Id: CorrelatorDataTestSl.cc,v 1.12 2011/05/04 18:15:34 abeard Exp $
#include <cmath>
...
const std::string CorrelatorDataTestSl::className_("CorrelatorDataTestSl");

/**.......................................................................
 * Constructor.
 */
CorrelatorDataTestSl::CorrelatorDataTestSl() {
  ccc_ = CorrelatorConfigChecker::getInstance();
  createTestData( 65 );
}

CorrelatorDataTestSl::CorrelatorDataTestSl( const int numChans ) {
  ccc_ = CorrelatorConfigChecker::getInstance();
  createTestData( numChans );
}
...
void CorrelatorDataTestSl::createTestData( const int numChans ) {
...
// 
void CorrelatorDataTestSl::simData(
