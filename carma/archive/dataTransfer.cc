...
int Program::main() {
  ...
  //sza data params
  vector<string> szaParams = vector<string>();
  szaParams.push_back(sdpconf["szaDir"]);
  szaParams.push_back(arvconf["szaDesRoot"]);

  vector<string> szaDirs = vector<string>();
  szaDirs.push_back(sdpconf["szaDir"]);
  string szaFilter = "sza_";
  ...
  while(true) {
    ...
    //int sza = 
      transfer->move_sza(szaParams, szaDirs, szaFilter);
    //int qr = 
