...
c
	  ...
	  call LogWrit(line)
	  write(line,'(a,12f5.0)') 'lsb gains:  ',lsb
	  call LogWrit(line)
	  write(line,'(a,12f5.0)') 'usb gains:  ',usb
	  call LogWrit(line)
	do j=1,nants
	...
	enddo
	  ...
	  call LogWrit(line)
c	call computr('PHASELO1',phaselo1,nants,error)
c	call computr('PHASELO2',phaselo2,nants,error)
c
	call LogClose
